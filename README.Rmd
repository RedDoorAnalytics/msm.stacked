...
The {msm.stacked} package can be used to simplify the creation of stacked probabilities plot from multi-state model fits from the [{msm}](https://CRAN.R-project.org/package=msm) package.
...
Predictions of state occupancy probabilities will not depend on the starting point:
